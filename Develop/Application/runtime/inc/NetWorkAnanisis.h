...
#define  NET_CMDCODE_0XE3   (0xe3)
#define  NET_CMDCODE_0XF3   (0xf3)

#define  NET_CMDCODE_0XE4   (0xe4)
#define  NET_CMDCODE_0XF4   (0xf4)

#define  NET_CMDCODE_0XE5   (0xe5)
#define  NET_CMDCODE_0XF5   (0xf5)
...
struct _cmd_code_0xe3
{
	short  UerID;//BYTE=2
	short  CMD_Serail;//BYTE=2
	unsigned char usr_infor[50];
	unsigned char usr_infor_2[80];
	short  deal_way;
	SYNCHRO_TIME_S deal_time;
	unsigned char money[12];
	unsigned char code[8];
};

struct _cmd_code_0xf3
{
	short  UerID;//BYTE=2
	short  CMD_Serail;//BYTE=2
	unsigned char usr_infor[50];
	unsigned char usr_infor_2[80];
	unsigned char center_num[15];
	int result;
	SYNCHRO_TIME_S deal_time;
	unsigned char code[8];
};

struct _cmd_code_0xe4
{
	short  UerID;//BYTE=2
	short  CMD_Serail;//BYTE=2
	unsigned char usr_infor[50];
...
struct _cmd_code_0xf4
{
	...
	SYNCHRO_TIME_S deal_time;
	unsigned char center_num[15];
	unsigned char BOSS_num[20];
};

struct _cmd_code_0xe5
{
	short  UerID;//BYTE=2
	short  CMD_Serail;//BYTE=2
	...
	unsigned char center_num[15];
	unsigned char order_num[20];
	unsigned char stub_num[8];
	unsigned char vin_num[17];
	unsigned char car_num[8];
	unsigned char soc_start;
	unsigned char soc_stop;
	short use_AH;
	short use_kwh;
	int use_time;
	unsigned char charge_type;
	short charge_num;
	unsigned char stop_normal;
	SYNCHRO_TIME_S start_time;
	SYNCHRO_TIME_S stop_time;
	SYNCHRO_TIME_S deal_time;
	int kwh_start;
	int kwh_stop;
};
struct _cmd_code_0xf5
{
	short  UerID;//BYTE=2
	short  CMD_Serail;//BYTE=2
	unsigned char stub_type;
	unsigned char usr_infor[50];
	unsigned char usr_infor_2[80];
	unsigned char time_kwh_soc[12];
	unsigned char ele_money[12];
	unsigned char service_money[12];
	unsigned char total_money[12];
	unsigned char center_num[15];
	SYNCHRO_TIME_S deal_time;
};
...
typedef struct
{
	...
	**************************/
	...
	struct _cmd_code_0xe3 p_cmd_code_0xe3;
	struct _cmd_code_0xf3  p_cmd_code_0xf3;

	struct _cmd_code_0xe4 p_cmd_code_0xe4;
	struct _cmd_code_0xf4  p_cmd_code_0xf4;

	struct _cmd_code_0xe5 p_cmd_code_0xe5;
	struct _cmd_code_0xf5  p_cmd_code_0xf5;
...
int SndPack_0xF3(const int senddata_ID,const int SndLinkRoad,const  struct _cmd_code_0xf3 p_cmd_code_0xf3_ipt,const unsigned char SendPack_SerialIpt,char NetworkCOnnectState);
int SndPack_0xF4(const int senddata_ID,const int SndLinkRoad,const  struct _cmd_code_0xf4 p_cmd_code_0xf4_ipt,const unsigned char SendPack_SerialIpt,char NetworkCOnnectState);
int SndPack_0xF5(const int senddata_ID,const int SndLinkRoad,const  struct _cmd_code_0xf5 p_cmd_code_0xf5_ipt,const unsigned char SendPack_SerialIpt,char NetworkCOnnectState);
