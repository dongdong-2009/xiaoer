...
int HistoryAnanisisnet_show(const char *file_name, struct _historyinfor  *p_cmd_code_0x92OutPt,int maxindex)
{
...
struct _historyinfor history_net_buf[30];
int sum_net=0;
void Dialog_history_net::init_page_val()
{
      ...
      //  sum_net=HistoryAnanisisnet_show(history_net_path, history_net_buf,30);
...
char *itoaa(unsigned int num,char*str)
{
...
void Dialog_history_net::update_page_info()
{
    ...
    else if(history_temp == 1)
    {
        ...
        ui->label_end->setText(itoaa(end,ttemp));
        ui->label_end_2->setText(itoaa(end_2,ttemp));
        ui->label_end_3->setText(itoaa(end_3,ttemp));
        ui->label_end_4->setText(itoaa(end_4,ttemp));
        ui->label_end_5->setText(itoaa(end_5,ttemp));

        ui->label_start->setText(itoaa(start,ttemp));
        ui->label_start_2->setText(itoaa(start_2,ttemp));
        ui->label_start_3->setText(itoaa(start_3,ttemp));
        ui->label_start_4->setText(itoaa(start_4,ttemp));
        ui->label_start_5->setText(itoaa(start_5,ttemp));
        ...
        {
            ui->label_time->setText(itoaa(chtime,ttemp));
        }
        ...
        {
            ui->label_time_2->setText(itoaa(chtime_2,ttemp));
        }
        ...
        {
            ui->label_time_3->setText(itoaa(chtime_3,ttemp));
        }
        ...
        {
            ui->label_time_4->setText(itoaa(chtime_4,ttemp));
        }
        ...
        {
            ui->label_time_5->setText(itoaa(chtime_5,ttemp));
        }
        ...
        {
            ui->label_meter->setText(itobb(meter,ttemp));
        }
        ...
        {
            ui->label_meter_2->setText(itobb(meter_2,ttemp));
        }
        ...
        {
          ui->label_meter_3->setText(itobb(meter_3,ttemp));
        }
        ...
        {
            ui->label_meter_4->setText(itobb(meter_4,ttemp));
        }
        ...
        {
             ui->label_meter_5->setText(itobb(meter_5,ttemp));
        }
...
void Dialog_history_net::on_pbtn_up_clicked()
{
        if(lbl_num-5>0)
     {
            ...
            start=history_net_buf[lbl_num-1].Start_Soc;
            start_2= history_net_buf[lbl_num_2-1].Start_Soc;
            start_3= history_net_buf[lbl_num_3-1].Start_Soc;
            start_4= history_net_buf[lbl_num_4-1].Start_Soc;
            start_5= history_net_buf[lbl_num_5-1].Start_Soc;

            end= history_net_buf[lbl_num-1].Stop_Soc;
            end_2= history_net_buf[lbl_num_2-1].Stop_Soc;
            end_3= history_net_buf[lbl_num_3-1].Stop_Soc;
            end_4= history_net_buf[lbl_num_4-1].Stop_Soc;
            end_5= history_net_buf[lbl_num_5-1].Stop_Soc;

            meter= (float)history_net_buf[lbl_num-1].Use_kwh/100;
            meter_2= (float)history_net_buf[lbl_num_2-1].Use_kwh/100;
            meter_3= (float)history_net_buf[lbl_num_3-1].Use_kwh/100;
            meter_4= (float)history_net_buf[lbl_num_4-1].Use_kwh/100;
            meter_5= (float)history_net_buf[lbl_num_5-1].Use_kwh/100;

            chtime= history_net_buf[lbl_num-1].chargecontinuetm/60;
            chtime_2= history_net_buf[lbl_num_2-1].chargecontinuetm/60;
            chtime_3= history_net_buf[lbl_num_3-1].chargecontinuetm/60;
            chtime_4= history_net_buf[lbl_num_4-1].chargecontinuetm/60;
            chtime_5= history_net_buf[lbl_num_5-1].chargecontinuetm/60;


            memcpy(lbl_txt, history_net_buf[lbl_num-1].CardNumber,sizeof(history_net_buf[lbl_num-1].CardNumber));
            memcpy(lbl_txt_2, history_net_buf[lbl_num_2-1].CardNumber,sizeof(history_net_buf[lbl_num-2].CardNumber));
            memcpy(lbl_txt_3, history_net_buf[lbl_num_3-1].CardNumber,sizeof(history_net_buf[lbl_num-3].CardNumber));
            memcpy(lbl_txt_4, history_net_buf[lbl_num_4-1].CardNumber,sizeof(history_net_buf[lbl_num-4].CardNumber));
            memcpy(lbl_txt_5, history_net_buf[lbl_num_5-1].CardNumber,sizeof(history_net_buf[lbl_num-5].CardNumber));
    }
     else
     {
