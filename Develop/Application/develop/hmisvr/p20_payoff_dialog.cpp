  ...
  //   UINT16 u16_data = 0;
   ...
   // ui->lbl_systime->setText(QTime::currentTime().toString("hh:mm:ss"));
    ...
    else  if(language_num == 2)
    {
     ...
     ui->lbl_usedmoney->setText(QString::number(f32_data,'f',2));
   ...
   //  ErrMsg("$$$$[%0.2f]$$$\n",f32_data);
     ...
     API_Read_DB_Nbyte(PL_CARD_STOP_FLAG,(INT8 *)(&u8_data),sizeof(u8_data));

     switch(u8_data)
     {
         case 1:
     //     ui->lbl_stopreason->setText(QString::fromUtf8("刷卡停止"));
          break;
         case 2:
     //     ui->lbl_stopreason->setText(QString::fromUtf8("APP停止"));
          break;
         case 3:
     //     ui->lbl_stopreason->setText(QString::fromUtf8("自动充满"));
          break;

         default:
     //    ui->lbl_stopreason->setText(QString::fromUtf8("其他"));
          break;
...
#if 0
void p20_payoff_dialog::tip_pull_gun()
{
	//QPalette pal;
	//pal.setColor(QPalette::WindowText,Qt::red);
	//ui->label_pull_gun_tip->setPalette(pal);	 

	ui->label_pull_gun_tip->setstylesheet(font:red);

}
#endif

void p20_payoff_dialog::on_pbtn_ok_clicked()
{
