...
HEADERS += main_dialog.h \
    ...
    p20_payoff_dialog.h \
    $(UBUNTU_XIAO_ER_AC_INC_RUNTIME_DIR)/inifile.h \
    $(UBUNTU_XIAO_ER_AC_INC_RUNTIME_DIR)/gui.h \
    $(UBUNTU_XIAO_ER_AC_INC_RUNTIME_DIR)/ioremap.h \
    $(UBUNTU_XIAO_ER_AC_INC_RUNTIME_DIR)/DB_Unity.h \
    #dialog_1.h \
    dialog_2.h \
...
INCLUDEPATH += $(UBUNTU_XIAO_ER_AC_INC_RUNTIME_DIR)
#LIBS += -L"/usr/local/qwt-arm/lib" \
LIBS += -L $(UBUNTU_XIAO_ER_AC_LIB_RUNTIME_DIR)\
    -lsem \
    -linireadwrite \
    -ldl
