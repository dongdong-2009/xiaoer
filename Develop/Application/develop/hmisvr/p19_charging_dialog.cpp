...
#if 0
void p19_charging_dialog::on_pbtn_endcharge_clicked()
{
    hmi_button_dn_num=PRESS_BUTTON_STOP;
    API_Write_DB_Nbyte(PL_HMI_BUTTON_DOWN,(INT8 *)(&hmi_button_dn_num),
                           sizeof(hmi_button_dn_num));
}
#endif
